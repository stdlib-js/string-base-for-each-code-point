...
```javascript
forEachCodePoint = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-for-each-code-point@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/string-base-for-each-code-point/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/string-base-for-each-code-point/actions/workflows/test.yml?query=branch:v0.2.3
